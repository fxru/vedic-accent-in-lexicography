...
\newfontfamily\devfont[Renderer=Graphite,Script=Devanagari,Language=Sanskrit]{Noto Serif Devanagari}
...
\newfontface\devbfont{Noto Serif Devanagari Bold}[Renderer=Graphite,Script=Devanagari,Language=Sanskrit]

%\newfontface\scshape{Cambria}[Letters=SmallCaps,Scale=1.15]
